...
//cria a variável e instância um objeto do tipo GlobalKey<FormState>()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 27, 22, 97),
      body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 20), // Espaço entre a imagem e o restante
               Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
...
Widget buildText(String texto, double size){
  ...
  Widget buildChoice(String label, BuildContext context) {  //Função retornando um Widget
    return ChoiceChip(   
      ...
      selectedColor: const Color.fromARGB(255, 111, 76, 175),
